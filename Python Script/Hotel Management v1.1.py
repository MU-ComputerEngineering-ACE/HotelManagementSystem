...
class hotelfarecal:
    ...
    def inputdata(self):
        self.name=input("\nEnter your name:")
        print ("\nEnter your address:")
        self.address="".join([input("\nName: "),",\n\t\t  ",input("\nStreet Name: "),",\n\t\t  ",input("\nStreet Number: "),",\n\t\t  ",input("\nCity: "),",\n\t\t  ",input("\nState: "),",\n\t\t  ",input("\nZip Code: ")])
        cindatentry=input("\nEnter your check in date in YYYY-MM-DD format:")
        yearin, monthin, dayin = map(int, cindatentry.split('-'))
        self.cindate=datetime.date(yearin,monthin,dayin)
        coutdatentry=input("\nEnter your check out date in YYYY-MM-DD format:")
        yearout, monthout, dayout = map(int, coutdatentry.split('-'))
        self.coutdate=datetime.date(yearout,monthout,dayout)
